...
public class SettingNoteElement : SettingDropdownElement
{
    ...
    public void SetValues(NoteShape selected, Color back, Color fore, Color back_fallback, Color fore_fallback, bool allowAlpha = false)
    {
        Background.texture = backgroundTextures[(int)selected];
        Background.color = back;
        backgroundPicker.SetValues(back, allowAlpha, backgroundKey, back_fallback);
        ...
        foregroundPicker.SetValues(fore, allowAlpha, foregroundKey, fore_fallback);
